...
public class CloseReciptChrome {
    ...
    public static void closerecipthw () throws Exception{
        ...
        Email.sendKeys("masukssa9@gmail.com");
        ...
        Address.clear();
        Address.sendKeys("21000 Le Fever Ave");
        Thread.sleep(1000);
        ...
        WebElement selectcard = driver.findElement(By.xpath("/html/body/div[2]/div/div/div[2]/div/div[2]/div[2]/div[3]/div[1]/div[2]/div/div/div[1]/div/div/div/div[1]/div/div[1]/div/div/div/div[2]/div/span[2]"));
        selectcard.click();
        Thread.sleep(1000);
...
*/
        ...
        System.out.println(" A confirmation email will be sent to masukssa9@gmail.com ");
